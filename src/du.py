...
class DU:
    ...
    def get_contents(self):
        ...
        print(
            ...
            f'{dt.fromtimestamp(self.parent_dir.last_modified).strftime(timestamp_format):<25}'
            f'{dt.fromtimestamp(self.parent_dir.created).strftime(timestamp_format):<25}'
        ...
        for el in self.contents:
            print(
                ...
                f'{el.level:<10}'
                f'{dt.fromtimestamp(el.last_modified).strftime(timestamp_format):<25}'
                f'{dt.fromtimestamp(el.created).strftime(timestamp_format):<25}'
                f'{el.owner:<10}')
        print('-' * 130)
